...
if __name__ == '__main__':
    ...
    while True:
        ...
        args = argparse.Namespace(input=argv[0], output=argv[1])
        ...
        compiler.compile_to_file(args.output, args.input, parse_file(args.input, scale_factor=(1,1), rotate_deg=0), passes=1)
